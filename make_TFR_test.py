...
save_path = './TFR'
out_file_name = 'DSEnet_DATA2_DEMAND_4_test.tfrecords'

target_dir = './DSEnet_test_DATA_1cm_4/LookD'
noisy_m1_dir = './DSEnet_test_DATA_1cm_4/MICR'
noisy_m2_dir = './DSEnet_test_DATA_1cm_4/MICL'
...
total_chunks = 0
for i in target_:
    fm, target = wavfile.read('./DSEnet_test_DATA_1cm_4/LookD/%s'%i)
#     print(type(target[0]))
    fm, noisy_m1 = wavfile.read('./DSEnet_test_DATA_1cm_4/MICR/%s'%i)
#     print(type(noisy_m1[0]))
    fm, noisy_m2 = wavfile.read('./DSEnet_test_DATA_1cm_4/MICL/%s'%i)
#     print(type(noisy_m2[0]))
...
for i in target_:
    if indx % 100 == 0:
        print('{}/{}'.format(indx + 1, 100*(total_chunks//100)))
